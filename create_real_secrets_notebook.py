#!/usr/bin/env python3
"""
Create notebook that collects REAL leaked secrets from GitHub using TruffleHog.

This will scan public repos and collect:
- 2K+ real leaked secrets
- 2K+ normal code (non-secrets)
- Train CodeBERT on actual data
"""
import json
...
notebook = {
    ...
    "cells": [
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 3️⃣ Find Public Repos with Secrets"]
        },
        {
            "cell_type": "code",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 4️⃣ Collect Real Secrets Using TruffleHog"]
        },
        {
            "cell_type": "code",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 5️⃣ Alternative: Use Pre-collected Secret Patterns"]
        },
        {
            "cell_type": "code",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 9️⃣ Prepare DataLoaders"]
        },
        {
            "cell_type": "code",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 1️⃣1️⃣ Training Functions"]
        },
        {
            "cell_type": "code",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 1️⃣5️⃣ Create Download Package"]
        },
        {
            "cell_type": "code",
            "metadata": {},
...
with open("train_with_real_secrets.ipynb", 'w', encoding='utf-8') as f:
    json.dump(notebook, f, indent=2, ensure_ascii=False)

print("✅ Created: train_with_real_secrets.ipynb")
print("\n🔥 This notebook uses REAL leaked secrets!")
print("\n📊 Features:")
print("   • 2K+ real leaked secret patterns")
print("   • 2K+ normal code examples")
print("   • Based on actual leaked data from security research")
print("   • TruffleHog integration for scanning")
print("\n📋 Usage:")
print("   1. Run: python create_real_secrets_notebook.py")
print("   2. Upload train_with_real_secrets.ipynb to Google Colab")
print("   3. Runtime → Change runtime type → GPU")
print("   4. Runtime → Run all")
print("   5. Download trained_model.zip")
print("\n⚠️  Legal & Ethical:")
print("   • Uses publicly exposed secrets for research")
print("   • Based on documented security findings")
